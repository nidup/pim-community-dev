...
class AbstractIteratorReaderSpec extends ObjectBehavior
{
    public function let()
    {
        $this->beAnInstanceOf('spec\Pim\Bundle\BaseConnectorBundle\Reader\StubArrayIteratorReader');
    }

    public function it_is_initializable()
    {
        $this->beConstructedWith(array());
        $this->shouldHaveType('spec\Pim\Bundle\BaseConnectorBundle\Reader\StubArrayIteratorReader');
    }
    ...
    public function it_sends_all_values_in_bulk_mode()
    {
        $values = array('value1', 'value2', 'value3');
...
class StubArrayIteratorReader extends AbstractIteratorReader
{
    /**
     * @var array
     */
