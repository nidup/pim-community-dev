...
class FileIteratorReader extends AbstractIteratorReader implements UploadedFileAwareInterface
{
     ...
     * @var array
     */
    protected $defaultIteratorOptions;
     ...
     * @param array               $defaultIteratorOptions
     */
    public function __construct(
        FileIteratorFactory $iteratorFactory,
        $iteratorClass,
        array $defaultIteratorOptions = array(),
        $batchMode = false
    ) {
        ...
        $this->defaultIteratorOptions = $defaultIteratorOptions;
    }
    ...
    /**
     * Returns the options of the iterator
     * 
     * @return array
     */
    protected function getIteratorOptions()
    {
        return $this->defaultIteratorOptions;
    }
}
